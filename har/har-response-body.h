...
enum _HarResponseBodyProperties {
  ...
  /* HarMessageBody */
  HAR_RESPONSE_BODY_COMPRESSED_LENGTH,
  HAR_RESPONSE_BODY_COMPRESSION,
  HAR_RESPONSE_BODY_ENCODING,
  HAR_RESPONSE_BODY_MIME_TYPE,
  HAR_RESPONSE_BODY_CHARSET,
  HAR_RESPONSE_BODY_LENGTH,
  HAR_RESPONSE_BODY_TEXT,
